...
const TranslatorApp = ({ onClose }) => {
  ...
  return (
    <div className="w-full flex flex-col gap-y-4 justify-center items-center px-6 sm:px-8 pt-12 pb-6 relative">
      ...
      <div className="w-full min-h-20 flex justify-center items-center px-4 bg-gradient-to-r from-[#3F5185] to-[#A1C6EA] text-gray-700 rounded-lg">
      ...
      {showLanguages && (
        <div
          className="w-[calc(100%-4rem)] h-[calc(100%-9rem)] bg-gradient-to-r from-[#3F5185] to-[#A1C6EA] absolute top-32 left-8 z-10 rounded shadow-lg p-4 overflow-y-scroll scrollbar-hide"
          ref={dropdownRef}
        >
          <ul>
      ...
      <p className="absolute bottom-1 left-4 text-sm text-gray-200">
